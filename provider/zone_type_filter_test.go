...
func TestZoneTypeFilterMatch(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{
			"", true, []any{publicZoneStr, privateZoneStr},
		},
		{
			"public", true, []any{publicZoneStr},
		},
		{
			"public", false, []any{privateZoneStr},
		},
		{
			"private", true, []any{privateZoneStr},
		},
		{
			"private", false, []any{publicZoneStr},
		},
		{
